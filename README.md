...
pixi add django-typer
# for installing globally
pixi global install django-typer
```
...
It is possible to list all of the versions of `django-typer` available on your platform:
...
```
pixi search django-typer --channel conda-forge
```
